...
| Settings | Display currency (rescales threshold marks to a rounded household size, not live FX); months (3–24) and three thresholds; Dates and balance lines (holiday shift, same-day `B` meaning) |
